...
?>
<div class="calendar-leafs <?php print $is_today ?>">
  ...
  <div class="info">
    <span class="subject"><?php print $fields['tid']->content ?></span>
    <h4><?php print $fields['title']->content; ?></h4>
    <span class="target-group"><?php print $fields['tid_1']->content ?></span>
  </div>

  <div class="meta">
    <span class="library"><?php print $fields['field_library_ref_nid']->content; ?></span>
